...
bot.on("messageReactionAdd", (messageReaction, user) => {
	try {
		...
		if (messageReaction.message.channel.id == bal.config[messageReaction.message.guild.id].petition.voteChannel && messageReaction.message.guild.id == DNTOguildID) {
			console.log(messageReaction.message.member.roles.find("name", "Leader"))
			if (!messageReaction.message.member.roles.find("name", "Leader")) {messageReaction.remove(user);return}
